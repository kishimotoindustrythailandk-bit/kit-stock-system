...
export const PERMISSION_KEYS = ["dashboard", "stock", "materials", "forecast", "parts", "tags", "plan", "arrange", "replacement", "dispatch", "exports", "reports", "history", "settings", "users"] as const;
